...
/*
async function main() {
	const megamanBattleNetwork3GBA = new SaveFileGameBoyAdvance('src/Gameboy Advance/Everdrive GBA X5/megaman_battle_network_3_white.sav'); // import our GBA save to an instance
