...
class SaveFileSuperNES extends SaveFile {
	...
	async exportWiiUVirtualConsoleSaveToMemory() {
		return await this._exportWiiUVOr3DSVirtualConsoleSaveToMemory(this._wiiUVirtualConsole);
	}

	async export3DSVirtualConsoleSaveToMemory() {
		return await this._exportWiiUVOr3DSVirtualConsoleSaveToMemory(this._3DSVirtualConsole);
	}
	...
	async export3DSVirtualConsoleSaveToFile(filePath) {
		// await fs.mkdir(filePath, { recursive: true });
