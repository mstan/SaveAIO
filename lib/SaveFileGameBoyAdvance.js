...
class SaveFileGameboyAdvance extends SaveFile {
	constructor(filePath,wiiUVirtualConsoleGameSaveSize) {
		super(filePath); // call parent constructor for basic initialization.

		this._wiiUVirtualConsoleGameSaveSize = wiiUVirtualConsoleGameSaveSize;
	...
	async _autoDetectSaveFileType() {
		...
		// return result ? result : this._buffer;
