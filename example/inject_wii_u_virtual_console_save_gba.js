...
async function main() {
	...
	await megamanBattleNetwork3WiiUVC.exportWiiUVirtualConsoleSaveToDisk('output/Wii U/Virtual Console/Megaman Battle Network 3 White/data_008_000.bin'); // write the file to disk to be used in a Wii U system.
}
main();
