...
async function main() {
	let mmbn3vc = new SaveFileGameBoyAdvance('src/Gameboy Advance/WiiU VC/Megaman Battle Network 3 White/data_008_0000.bin','wii_u_virtual_console', { wiiUVirtualConsoleGameSaveSize: 32768 });
